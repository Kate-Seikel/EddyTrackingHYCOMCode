...
% function Step4_Stat_trajectories(input_dir,ndays)
%
...
function Step4_Stat_trajectories_BoB(basepath)
addpath(strcat(basepath, 'FUNCTIONS'));

close all
clc
katepath = '/Volumes/Kate-Research/Data/Eddy_Extraction/EDDY_PROPERTIES';
input_dir= katepath; %EDDY_PROPERTIES'];

%input_dir = input('Path of the directory containing EXTRACTION and FUNCTIONS : ','s');
%addpath('/Volumes/SAN2/EDDY_Paper/Eddy_Identification_CHAIGNEAU/FUNCTIONS/');
...
% Works when use single loop - take out one loop at a time to find issue :)
%
% for j=1:ndays-1
%
%
...
%load('/Volumes/SAN2/EDDY_Paper/Eddy_Identification_CHAIGNEAU/EXTRACTION/E_Track_pt3_1.mat')
...
% Store number of days used
% Metada().Nbr_estimate_stat = Nestimate_lim;
...
% load('/Volumes/SAN2/EDDY_Paper/Eddy_Identification_CHAIGNEAU/EXTRACTION/E_Track_266.mat')
...
% %
% % ANTICYCLONES:
% %      Delta Amplitudes :    -0.0050621     0.25507
% %      Delta Radii :    -0.064839      3.1057
% %      Delta EKE :    -0.292396      17.2492
% %      Delta Distances :    7.9678      257.7242
% %
% % CYCLONES:
% %      Delta Amplitudes :    -0.008421      1.0697
% %      Delta Radii :    -0.0642058      12.0492
% %      Delta EKE :    -1.509205      160.9531
% %      Delta Distances :    9.17425      17.4094
end